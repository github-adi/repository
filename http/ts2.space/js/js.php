...
-Link Address Java Script:
http://ts2.space/js/js.php
...
(function($){
	...
	$.fn.lightbox.defaults = {
		...
		displayHelp: false,
		strings : {
			help: ' \u2190 / P - previous image\u00a0\u00a0\u00a0\u00a0\u2192 / N - następne image\u00a0\u00a0\u00a0\u00a0ESC / X - zamknij galerie',
...
$(function(){
	$('#ButtonRsp1').append('<div class="button"><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span></div>');
	var mainMenu = $('#mainMenu ul').html();
	$('#MenuRsp nav').html('<ul>' + mainMenu + '</ul>');

	$("#ButtonRsp1").click(function(){
	...
	var mainMenuBottom = $('#leftMenu').html();
	$('.menu-bottom-1').html('<div class=leftMenu>' + mainMenuBottom + '</div>');	
...
jQuery(document).ready(function () {
	...
	jQuery("#projectsSlider ul li a").click(function() {
		jQuery("#projectsSlider ul li a").removeClass('active');
		jQuery("#projectsSlider ul li a span").remove();
		jQuery(this).addClass('active');
		jQuery('<span class="border"></span>').insertAfter(jQuery('#projectsSlider ul li a.active img'));
		jQuery.post("/ajax/realizacjaPobierz.php", { id: jQuery(this).attr('id') }, function(data) {
			jQuery(".portfolioBox").replaceWith(data);
			Cufon.replace("h1");
			Cufon.replace("h2");
		});
		return false;
...
function SendFormXKod(form,send)
{
    var d = new Date();
    var n = d.getDate();
    //alert(n);
    var kod_formularza = jQuery("#"+send).val();
    //alert(kod_formularza);
    var kod = kod_formularza + n;
    //alert(kod);
    jQuery("#send").val(kod);
    jQuery("#kod").val(n);
    jQuery("#"+form).submit();
...
function SendForm2()
{
	jQuery("#send").val("73673637");
	jQuery("#formular").submit();
}

function SendForm3()
{
	jQuery("#send").val("3880011");
	jQuery("#formular").submit();
}
